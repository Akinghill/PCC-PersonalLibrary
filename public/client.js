$(document).ready(function () {
  ...
  $('#display').on('click', 'li.bookItem', function () {
    ...
    let bookid = itemsRaw[this.id]._id
    ...
    $.getJSON('/api/books/' + itemsRaw[this.id]._id, function (data) {
      ...
      comments.push('<br><button class="btn btn-info addComment" id="' + bookid + '">Add Comment</button>');
      comments.push('<button class="btn btn-danger deleteBook" id="' + bookid + '">Delete Book</button>');
